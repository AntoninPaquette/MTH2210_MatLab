function [temps , y] = euler_imp(f , tspan , Y0 , nb_pas, h_nl)
...
%	[temps , y] = euler_imp(@(t,z) [z(2);-10*z(1)] , [0,1] , [1;0] , 1000, 1e-3);
...
for t=1:nb_pas
	...
	[approx , err_abs] = newton_ND_sans_der(fct_nl, h_nl, y(:,t) , 20 , 1e-12);
