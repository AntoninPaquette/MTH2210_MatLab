...
% NEWTON_ND_AVEC_DER	Methode de Newton pour la resolution de F(x) = 0, pour F: R^n -> R^n
%
...
%	mat_jac		-	String ou function handle specifiant la matrice
...
%%  Verification de la fonction F et de la matrice jacobienne
if isa(F,'char')
	fct			=	str2func(F);
	is_fct_file =	true;
