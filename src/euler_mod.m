...
% EULER_MOD	Méthode d'Euler modifiée d'ordre 2 avec pas constant pour la
%			résolution d'EDOs
%
...
%
% Arguments de sortie
%	temps	-	Vecteur rangée contenant les valeurs de temps t_i
%	y		-	Matrice de dimension N x (nb_pas+1) dont les rangées 
...
%%  Vérification de la fonction contenant la définition des dérivées
if isa(f,'char')
	fct		=	str2func(f);
...
%% Méthode d'Euler modifiée d'ordre 2 avec pas constant
for t=1:nb_pas
	yt			=	y(:,t);
