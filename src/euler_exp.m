...
%			résolution d'EDOs
%
% Syntaxe: [temps , y] = euler_exp(f , tspan , Y0 , nb_pas)
%
% Arguments d'entrée
...
if ~isnumeric(Y0) || ~isvector(Y0)
	error('Les conditions initiales Y0 ne sont pas arrangées en vecteur')
end
...
for t=1:nb_pas
	y(t+1,:)	=	y(t,:) + h*reshape(fct(temps(t),y(t,:)),1,nb_comp);
end
